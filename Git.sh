...
while echo -e -n "\n\n\033[01;36mPlease choose the first letter of options.\n$options? \033[0m "
	read -n1 choice
do
	echo -e "\n"
	case $choice in
	A | a)
		...
		git status;;
	C | c)
		echo -e -n "\033[01;36mPlease enter the remark: \033[0m "
		read commit
	...
	F | f)
		...
		if [[ $merge_choice == 'y' ]] || [[ $merge_choice == 'Y' ]]; then
			...
			echo -e -n "\033[01;36mHaved canceled the merge option.\n \033[0m "
		fi
	...
	L | l)
		echo -e -n "\033[01;36mIt only shows the logs for nearly two weeks. \033[0m "
	...
	P | p)
			...
			git status;;
	U | u)
		echo -e "\033[01;36mPlease input user's instructions. \033[0m "
		while read -p ">> " myCmd
		do
			echo $myCmd
			if [[ $myCmd != '' ]]; then
	...
	R | r)
		...
		echo -e -n "\033[01;36mPlease enter the reset_id: \033[0m "
		read reset_id
